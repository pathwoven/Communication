...
type Chat struct {
	...
	UserID      uint      `gorm:"type:int;not null;index:user_target_id_idx,priority:1"`
	TargetID    uint      `gorm:"type:int;not null;index:user_target_id_idx,priority:2;comment:对方的id"`
	...
	Tag1ID      uint      `gorm:"type:int;default:null"`
	Tag2ID      uint      `gorm:"type:int;default:null"`
	Tag3ID      uint      `gorm:"type:int;default:null"`
}
